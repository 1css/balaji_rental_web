    ...
    <footer className="footer">
      <div className="footer-grid wrap">
        <div className="footer-col footer-col--brand">
          ...
          <p className="footer-tagline">
            Commercial and industrial spaces across Tumakuru&rsquo;s growing
            business zones — leased on transparent, flexible terms.
          </p>
          <div className="footer-group">
            <a
              className="footer-group-link"
              href="https://www.balajitransports.in"
              target="_blank"
              rel="noreferrer"
            >
              Balaji Transports
      ...
      <div className="footer-bottom wrap">
        <span className="footer-copyright">
          &copy; Balaji Rentals {year}. All rights reserved.
        </span>
