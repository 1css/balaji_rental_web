    ...
    <>
      <section className="contact-hero">
        <div className="contact-hero-inner wrap">
          ...
          <h1 className="contact-hero-title">
            Let&rsquo;s talk about your rental needs
          </h1>

          <p className="contact-hero-desc">
            We&rsquo;d love to show you around our properties or help you choose
      ...
      <section className="contact-map">
        <div className="contact-map-inner wrap">
          <SectionHeading
            sheet="A-02 · Our office"
            title="Visit us in Tumkur"
            description="We're located in the heart of Tumkur — come by during business hours."
          />
